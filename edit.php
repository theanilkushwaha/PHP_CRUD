...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `empdata` SET `First_name`='$fname',`Last_name`='$lname',`Nationality`='$nationality',`Email`='$email',`Date_of_birth`='$dob' WHERE id = $id";
...
<div class="header">
  ...
  <div class="container">
    ...
    <?php
    $sql = "SELECT * FROM `empdata` WHERE id = $id LIMIT 1";
    $result = mysqli_query($conn, $sql);
